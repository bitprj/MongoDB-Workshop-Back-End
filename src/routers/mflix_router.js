...
router.get('/mflix_questions/1', async (req, res) => {
    try{
        ...
        res.status(200).send({correctAnswer: data[0]._id, answer : 'R', order:1})
...
router.get('/mflix_questions/2', async (req, res) => {
    try{
        ...
        // console.log(data)
        res.status(200).send({correctAnswer: data[0]._id, answer : 'E', order:2})
    }catch(error){
        res.status(400).send(error)
    }
...
router.get('/mflix_questions/3', async (req, res) => {
    try{
        ...
        // console.log(data)
        res.status(200).send({correctAnswer: data[0]._id, answer : 'A', order:3})
    }catch(error){
        res.status(400).send(error)
    }
...
router.get('/mflix_questions/4', async (req, res) => {
    try{
        ...
        // console.log(data)
        res.status(200).send({correctAnswer: data[0]._id, answer : 'C', order:4})
    }catch(error){
        res.status(400).send(error)
    }
...
router.get('/mflix_questions/5', async (req, res)=>{
    try{
        ...
        console.log(data)
        res.status(200).send({correctAnswer: data[0]._id, answer : 'T', order:5})
