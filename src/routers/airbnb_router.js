...
router.get('/airbnb_questions/1', async (req, res) => {
    try{   
        ...
        res.status(200).send({correctAnswer:data[0]._id, answer:'B', order:1})
...
router.get('/airbnb_questions/2', async(req, res) =>{
    try{
         ...
         res.status(200).send({correctAnswer:data[0]._id, answer:'I', order:2})
    }catch(error){
        res.status(400).send(error)
    }
})
...
router.get('/airbnb_questions/4', async(req, res) =>{
    try{
         ...
         res.status(200).send({correctAnswer:data[0]._id, answer:'P', order:4})
    }catch(error){
        res.status(400).send(error)
    }
})
router.get('/airbnb_questions/5', async(req, res) =>{
    try{
         ...
         res.status(200).send({correctAnswer:data[0]._id, answer:'R', order:5})
    }catch(error){
        res.status(400).send(error)
    }
})
...
router.get('/airbnb_questions/6', async(req, res) =>{
    try{
         ...
         res.status(200).send({correctAnswer:data[0]._id, answer:'O', order:6})
    }catch(error){
        res.status(400).send(error)
    }
})
router.get('/airbnb_questions/7', async(req, res) =>{
    try{
         ...
         res.status(200).send({correctAnswer:data[0]._id, answer:'J', order:7})
    }catch(error){
        res.status(400).send(error)
    }
})
